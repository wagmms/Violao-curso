...
async function runTests() {
  ...
  fs.mkdirSync('entregas-gemini/lote-6/revisado', { recursive: true });
  fs.writeFileSync('entregas-gemini/lote-6/revisado/TESTES-NAVEGADOR.json', JSON.stringify(report, null, 2), 'utf8');
  return allOk;
}
